...
//        speed = speed * 0.083f; // speed in M/S
    ...
    public static void calculateControl(PacketTools.mc_values values, PacketTools.mc_states states){
        ...
        phi = (double) constrainAbsVal((float) phi, 45);
        phi_dot = (double) constrainAbsVal((float) phi_dot, 90);
        psi = (double) constrainAbsVal((float) phi, control.psiLimit);
        psi_dot = (double) constrainAbsVal((float) phi_dot, 90);
        theta = (double) constrainAbsVal((float) theta, control.thetaLimit);
        theta_dot = (double) constrainAbsVal((float) theta_dot, 90);
        ...
        commonModeCtrlText.setText("Common Mode Control: " + control.commonModeCtrl);
        differentialCtrlText.setText("Differential Control: " + control.differentialCtrl);
